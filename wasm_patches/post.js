...
Module['pywrap_init_phase_1'] = function(prefix, python_version, verbose) {
    ...
    if(verbose){console.log("in pywrap_init_phase_1 done!!");}
}

Module['pywrap_init_phase_2'] =  function(prefix, python_version, verbose) {
    let default_scope = Module["default_scope"];

    // make the python pyjs module easy available
    if(verbose){console.log("in pywrap_init_phase_2");}
